...
public:
    ...
    inline Tquaternion(T _w, T _x, T _y, T _z)
        : r(_w),
          v(_x, _y, _z)
    {
...
template <typename T>
static inline Tquaternion<T> conjugate(const Tquaternion<T>& q)
{
...
static inline mat4 invert(const mat4& rkInput)
{
	float det;
	mat4 inv;
	int i;

	inv[0][0] = rkInput[1][1] * rkInput[2][2] * rkInput[3][3] -
		rkInput[1][1] * rkInput[2][3] * rkInput[3][2] -
		rkInput[2][1] * rkInput[1][2] * rkInput[3][3] +
		rkInput[2][1] * rkInput[1][3] * rkInput[3][2] +
		rkInput[3][1] * rkInput[1][2] * rkInput[2][3] -
		rkInput[3][1] * rkInput[1][3] * rkInput[2][2];

	inv[1][0] = -rkInput[1][0] * rkInput[2][2] * rkInput[3][3] +
		rkInput[1][0] * rkInput[2][3] * rkInput[3][2] +
		rkInput[2][0] * rkInput[1][2] * rkInput[3][3] -
		rkInput[2][0] * rkInput[1][3] * rkInput[3][2] -
		rkInput[3][0] * rkInput[1][2] * rkInput[2][3] +
		rkInput[3][0] * rkInput[1][3] * rkInput[2][2];

	inv[2][0] = rkInput[1][0] * rkInput[2][1] * rkInput[3][3] -
		rkInput[1][0] * rkInput[2][3] * rkInput[3][1] -
		rkInput[2][0] * rkInput[1][1] * rkInput[3][3] +
		rkInput[2][0] * rkInput[1][3] * rkInput[3][1] +
		rkInput[3][0] * rkInput[1][1] * rkInput[2][3] -
		rkInput[3][0] * rkInput[1][3] * rkInput[2][1];

	inv[3][0] = -rkInput[1][0] * rkInput[2][1] * rkInput[3][2] +
		rkInput[1][0] * rkInput[2][2] * rkInput[3][1] +
		rkInput[2][0] * rkInput[1][1] * rkInput[3][2] -
		rkInput[2][0] * rkInput[1][2] * rkInput[3][1] -
		rkInput[3][0] * rkInput[1][1] * rkInput[2][2] +
		rkInput[3][0] * rkInput[1][2] * rkInput[2][1];

	inv[0][1] = -rkInput[0][1] * rkInput[2][2] * rkInput[3][3] +
		rkInput[0][1] * rkInput[2][3] * rkInput[3][2] +
		rkInput[2][1] * rkInput[0][2] * rkInput[3][3] -
		rkInput[2][1] * rkInput[0][3] * rkInput[3][2] -
		rkInput[3][1] * rkInput[0][2] * rkInput[2][3] +
		rkInput[3][1] * rkInput[0][3] * rkInput[2][2];

	inv[1][1] = rkInput[0][0] * rkInput[2][2] * rkInput[3][3] -
		rkInput[0][0] * rkInput[2][3] * rkInput[3][2] -
		rkInput[2][0] * rkInput[0][2] * rkInput[3][3] +
		rkInput[2][0] * rkInput[0][3] * rkInput[3][2] +
		rkInput[3][0] * rkInput[0][2] * rkInput[2][3] -
		rkInput[3][0] * rkInput[0][3] * rkInput[2][2];

	inv[2][1] = -rkInput[0][0] * rkInput[2][1] * rkInput[3][3] +
		rkInput[0][0] * rkInput[2][3] * rkInput[3][1] +
		rkInput[2][0] * rkInput[0][1] * rkInput[3][3] -
		rkInput[2][0] * rkInput[0][3] * rkInput[3][1] -
		rkInput[3][0] * rkInput[0][1] * rkInput[2][3] +
		rkInput[3][0] * rkInput[0][3] * rkInput[2][1];

	inv[3][1] = rkInput[0][0] * rkInput[2][1] * rkInput[3][2] -
		rkInput[0][0] * rkInput[2][2] * rkInput[3][1] -
		rkInput[2][0] * rkInput[0][1] * rkInput[3][2] +
		rkInput[2][0] * rkInput[0][2] * rkInput[3][1] +
		rkInput[3][0] * rkInput[0][1] * rkInput[2][2] -
		rkInput[3][0] * rkInput[0][2] * rkInput[2][1];

	inv[0][2] = rkInput[0][1] * rkInput[1][2] * rkInput[3][3] -
		rkInput[0][1] * rkInput[1][3] * rkInput[3][2] -
		rkInput[1][1] * rkInput[0][2] * rkInput[3][3] +
		rkInput[1][1] * rkInput[0][3] * rkInput[3][2] +
		rkInput[3][1] * rkInput[0][2] * rkInput[1][3] -
		rkInput[3][1] * rkInput[0][3] * rkInput[1][2];

	inv[1][2] = -rkInput[0][0] * rkInput[1][2] * rkInput[3][3] +
		rkInput[0][0] * rkInput[1][3] * rkInput[3][2] +
		rkInput[1][0] * rkInput[0][2] * rkInput[3][3] -
		rkInput[1][0] * rkInput[0][3] * rkInput[3][2] -
		rkInput[3][0] * rkInput[0][2] * rkInput[1][3] +
		rkInput[3][0] * rkInput[0][3] * rkInput[1][2];

	inv[2][2] = rkInput[0][0] * rkInput[1][1] * rkInput[3][3] -
		rkInput[0][0] * rkInput[1][3] * rkInput[3][1] -
		rkInput[1][0] * rkInput[0][1] * rkInput[3][3] +
		rkInput[1][0] * rkInput[0][3] * rkInput[3][1] +
		rkInput[3][0] * rkInput[0][1] * rkInput[1][3] -
		rkInput[3][0] * rkInput[0][3] * rkInput[1][1];

	inv[3][2] = -rkInput[0][0] * rkInput[1][1] * rkInput[3][2] +
		rkInput[0][0] * rkInput[1][2] * rkInput[3][1] +
		rkInput[1][0] * rkInput[0][1] * rkInput[3][2] -
		rkInput[1][0] * rkInput[0][2] * rkInput[3][1] -
		rkInput[3][0] * rkInput[0][1] * rkInput[1][2] +
		rkInput[3][0] * rkInput[0][2] * rkInput[1][1];

	inv[0][3] = -rkInput[0][1] * rkInput[1][2] * rkInput[2][3] +
		rkInput[0][1] * rkInput[1][3] * rkInput[2][2] +
		rkInput[1][1] * rkInput[0][2] * rkInput[2][3] -
		rkInput[1][1] * rkInput[0][3] * rkInput[2][2] -
		rkInput[2][1] * rkInput[0][2] * rkInput[1][3] +
		rkInput[2][1] * rkInput[0][3] * rkInput[1][2];

	inv[1][3] = rkInput[0][0] * rkInput[1][2] * rkInput[2][3] -
		rkInput[0][0] * rkInput[1][3] * rkInput[2][2] -
		rkInput[1][0] * rkInput[0][2] * rkInput[2][3] +
		rkInput[1][0] * rkInput[0][3] * rkInput[2][2] +
		rkInput[2][0] * rkInput[0][2] * rkInput[1][3] -
		rkInput[2][0] * rkInput[0][3] * rkInput[1][2];

	inv[2][3] = -rkInput[0][0] * rkInput[1][1] * rkInput[2][3] +
		rkInput[0][0] * rkInput[1][3] * rkInput[2][1] +
		rkInput[1][0] * rkInput[0][1] * rkInput[2][3] -
		rkInput[1][0] * rkInput[0][3] * rkInput[2][1] -
		rkInput[2][0] * rkInput[0][1] * rkInput[1][3] +
		rkInput[2][0] * rkInput[0][3] * rkInput[1][1];

	inv[3][3] = rkInput[0][0] * rkInput[1][1] * rkInput[2][2] -
		rkInput[0][0] * rkInput[1][2] * rkInput[2][1] -
		rkInput[1][0] * rkInput[0][1] * rkInput[2][2] +
		rkInput[1][0] * rkInput[0][2] * rkInput[2][1] +
		rkInput[2][0] * rkInput[0][1] * rkInput[1][2] -
		rkInput[2][0] * rkInput[0][2] * rkInput[1][1];

	det = rkInput[0][0] * inv[0][0] + rkInput[0][1] * inv[1][0] + rkInput[0][2] * inv[2][0] + rkInput[0][3] * inv[3][0];
...
template <typename T>
static inline Tmat4<T> translate(const vecN<T, 4>& v)
{
	return translate(v[0], v[1], v[2]);
}
...
static inline quaternion Slerp(const quaternion& qa, const quaternion& qb, float t)
{
	//quaternion qatob = conjugate(qa) * qb;
    //get theta
	float costhetahalf = qa[0] * qb[0] + qa[1] * qb[1] + qa[2] * qb[2] + qa[3] * qb[3];
	...
	float halfTheta = acos(costhetahalf);
	float sinHalfTheta = sqrt(1.0f - costhetahalf*costhetahalf);
	quaternion qm;
